...
export type AuthMechanism = HttpBearerAuth | ApiKeyHeaderAuth | ApiKeyQueryAuth | OAuth2AuthCodeAuth;
...
export type ExtractParam = StringParam | NumberParam | BooleanParam | OptionsParam | JsonParam;
...
export type ParamSkipReason = "missing-schema" | "missing-param-type" | "unsupported-param-type";
